...
class TestDataLibrary(TestCase):
    ...
    def test_build_property_alias_dict(self):
        ...
        expected = {
            ...
            'border-bottom': {'bb-', 'border-b-'}, 'cursor': {'cur-'}, 'cue': set(),
            'font-weight': {'fweight-', 'lighter', 'fw-', 'bolder', 'f-weight-', 'font-w-', 'bold'},
            'left': set(), 'quotes': {'quo-'}, 'max-height': {'max-h-'},
            'text-decoration': {'underline', 'overline', 'line-through', 'blink', 'text-d-', 'td-'},
            ...
            'border-collapse': set(), 'speak-header': {'sh-', 'speak-h-'},
            ...
            'text-transform': {'capitalize', 'uppercase', 'lowercase', 'tt-', 'text-t-'},
            'padding-right': {'padding-r-'}, 'max-width': {'max-w-'},

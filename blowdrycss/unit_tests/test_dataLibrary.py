...
# custom
from blowdrycss.datalibrary import DataLibrary     # Normally one would never do this.
...
class TestDataLibrary(TestCase):
    ...
    def test_default_property_alias_dict(self):
        ...
        expected = {
            ...
            'background-repeat': {'no-repeat', 'repeat-x', 'background-r-', 'repeat-y'}, 'pause': set(),
            'azimuth': {'left-side', 'right-side', 'far-left', 'leftwards', 'rightwards', 'center-right', 'azi-',
                        'behind', 'far-right', 'center-left'}, 'word-spacing': {'word-s-'},

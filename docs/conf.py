...
# -*- coding: utf-8 -*-
#
# blowdrycss documentation build configuration file, created by
...
release = current_version['__release__']
...
htmlhelp_basename = 'blowdrycssdoc'
...
texinfo_documents = [
  (master_doc, 'blowdrycss', 'blowdrycss Documentation',
   author, 'blowdrycss', 'One line description of project.',
   'Miscellaneous'),
]
...
# -- Options for Autodoc config values ---------------------------------------------

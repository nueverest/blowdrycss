...
| clip                                 |                                      |
+--------------------------------------+--------------------------------------+
| color                                | ``lightgrey`` ``snow`` ``c-``        |
|                                      | ``rosybrown`` ``lightsteelblue``     |
|                                      | ``indigo`` ``ivory`` ``dimgrey``     |
|                                      | ``darkcyan`` ``magenta``             |
|                                      | ``springgreen`` ``navy`` ``hotpink`` |
|                                      | ``coral`` ``orchid``                 |
|                                      | ``deepskyblue`` ``lightslategray``   |
|                                      | ``darkorchid`` ``peru``              |
|                                      | ``dodgerblue``                       |
|                                      | ``lavender`` ``plum``                |
|                                      | ``lightseagreen`` ``darkgray``       |
|                                      | ``darkgoldenrod``                    |
|                                      | ``palevioletred`` ``slategrey``      |
|                                      | ``rgb`` ``saddlebrown``              |
|                                      | ``darkslategrey``                    |
|                                      | ``wheat`` ``pink`` ``bisque``        |
|                                      | ``lightskyblue`` ``darkblue``        |
|                                      | ``mediumvioletred`` ``lemonchiffon`` |
|                                      | ``beige`` ``gray`` ``limegreen``     |
|                                      | ``midnightblue`` ``ghostwhite``      |
|                                      | ``cornflowerblue`` ``lightpink``     |
|                                      | ``darkmagenta``                      |
|                                      | ``aquamarine`` ``mediumslateblue``   |
|                                      | ``violet`` ``darkgrey``              |
|                                      | ``mediumaquamarine``                 |
|                                      | ``hsl`` ``turquoise`` ``palegreen``  |
|                                      | ``mediumblue`` ``gold``              |
|                                      | ``paleturquoise`` ``greenyellow``    |
|                                      | ``hsla`` ``aqua`` ``powderblue``     |
|                                      | ``thistle`` ``papayawhip``           |
|                                      | ``mediumspringgreen`` ``seagreen``   |
|                                      | ``moccasin``                         |
|                                      | ``rgba`` ``oldlace``                 |
|                                      | ``lightslategrey`` ``darkslateblue`` |
|                                      | ``fuchsia``                          |
|                                      | ``indianred`` ``lightblue``          |
|                                      | ``skyblue`` ``sienna`` ``chocolate`` |
|                                      | ``yellow`` ``teal``                  |
|                                      | ``lavenderblush`` ``gainsboro``      |
|                                      | ``purple``                           |
|                                      | ``mintcream`` ``linen``              |
...
|                                      | ``cornsilk`` ``darkkhaki``           |
|                                      | ``palegoldenrod`` ``darksalmon``     |
|                                      | ``peachpuff`` ``darkorange``         |
|                                      | ``blue``                             |
|                                      | ``tomato`` ``salmon`` ``green``      |
|                                      | ``darkred`` ``mediumorchid``         |
|                                      | ``orange`` ``mistyrose``             |
|                                      | ``darkslategray`` ``honeydew``       |
|                                      | ``maroon``                           |
|                                      | ``sandybrown`` ``slateblue``         |
|                                      | ``crimson`` ``brown`` ``azure``      |
|                                      | ``yellowgreen`` ``darkolivegreen``   |
|                                      | ``silver`` ``darkviolet``            |
|                                      | ``lightgoldenrodyellow``             |
|                                      | ``mediumturquoise`` ``lime``         |
|                                      | ``blanchedalmond`` ``lawngreen``     |
|                                      | ``forestgreen``                      |
|                                      | ``olivedrab`` ``darkturquoise``      |
|                                      | ``lightyellow`` ``darkseagreen``     |
|                                      | ``mediumseagreen``                   |
|                                      | ``aliceblue`` ``white``              |
|                                      | ``royalblue`` ``slategray``          |
|                                      | ``seashell``                         |
...
|                                      | ``antiquewhite`` ``khaki``           |
|                                      | ``lightgray``                        |
|                                      | ``lightgreen`` ``orangered``         |
|                                      | ``olive`` ``lightcoral`` ``grey``    |
|                                      | ``tan`` ``navajowhite``              |
|                                      | ``mediumpurple`` ``red``             |
|                                      | ``floralwhite``                      |
|                                      | ``cadetblue`` ``deeppink``           |
...
| cue-before                           | ``cb-`` ``cue-b-``                   |
+--------------------------------------+--------------------------------------+
| cursor                               | ``s-resize`` ``crosshair``           |
|                                      | ``progress`` ``text`` ``w-resize``   |
|                                      | ``cur-`` ``n-resize`` ``e-resize``   |
|                                      | ``pointer`` ``wait``                 |
|                                      | ``ne-resize`` ``move`` ``default``   |
|                                      | ``se-resize`` ``help``               |
|                                      | ``sw-resize`` ``nw-resize``          |
+--------------------------------------+--------------------------------------+
| direction                            | ``dir-`` ``rtl`` ``ltr``             |
+--------------------------------------+--------------------------------------+
| display                              | ``table-caption`` ``table-row``      |
|                                      | ``inline-table`` ``table-cell``      |
|                                      | ``xgiant``                           |
|                                      | ``medium`` ``xxlarge`` ``table``     |
|                                      | ``table-column-group``               |
|                                      | ``inline-block``                     |
|                                      | ``xsmall`` ``dis-`` ``xlarge``       |
|                                      | ``large`` ``xxsmall``                |
|                                      | ``giant`` ``table-footer-group``     |
...
| font                                 |                                      |
+--------------------------------------+--------------------------------------+
| font-family                          | ``cursive`` ``palatino`` ``fantasy`` |
|                                      | ``cambria`` ``arial``                |
|                                      | ``monospace`` ``calibri``            |
|                                      | ``garamond`` ``courier`` ``monaco``  |
|                                      | ``font-f-`` ``helvetica``            |
|                                      | ``consolas`` ``optima`` ``papyrus``  |
|                                      | ``geneva`` ``didot`` ``ff-``         |
|                                      | ``serif`` ``candara``                |
|                                      | ``tahoma`` ``verdana``               |
|                                      | ``copperplate`` ``impact``           |
...
|                                      | ``list-s-position-``                 |
+--------------------------------------+--------------------------------------+
| list-style-type                      | ``lower-alpha`` ``upper-latin``      |
|                                      | ``armenian`` ``disc``                |
|                                      | ``decimal-leading-zero``             |
|                                      | ``upper-roman`` ``lower-roman``      |
|                                      | ``upper-alpha`` ``list-s-type-``     |
|                                      | ``decimal``                          |
|                                      | ``circle`` ``lower-greek`` ``lst-``  |
...
+--------------------------------------+--------------------------------------+
| speech-rate                          | ``x-fast`` ``slow`` ``speech-r-``    |
|                                      | ``sr-`` ``slower``                   |
|                                      | ``x-slow`` ``faster`` ``fast``       |
+--------------------------------------+--------------------------------------+
| stress                               | ``str-``                             |
...
|                                      | ``t-align-``                         |
+--------------------------------------+--------------------------------------+
| text-decoration                      | ``overline`` ``td-`` ``blink``       |

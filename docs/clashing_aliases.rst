...
| cue-before                           | ``cb-`` ``cue-b-``                   |
+--------------------------------------+--------------------------------------+
| cursor                               | ``pointer`` ``nw-resize``            |
|                                      | ``w-resize`` ``default`` ``wait``    |
|                                      | ``help`` ``s-resize`` ``move``       |
|                                      | ``text`` ``se-resize``               |
|                                      | ``crosshair`` ``ne-resize``          |
|                                      | ``sw-resize`` ``cur-`` ``progress``  |
|                                      | ``e-resize`` ``n-resize``            |
+--------------------------------------+--------------------------------------+
...
|                                      | ``table-caption`` ``giant``          |
|                                      | ``xlarge``                           |
|                                      | ``dis-`` ``table-column`` ``table``  |
|                                      | ``medium`` ``inline-table``          |
|                                      | ``inline-block`` ``block``           |
|                                      | ``xxsmall`` ``inline`` ``xxlarge``   |
+--------------------------------------+--------------------------------------+
| elevation                            | ``lower`` ``below`` ``higher``       |
|                                      | ``level`` ``above``                  |
|                                      | ``ele-``                             |
+--------------------------------------+--------------------------------------+
...
| font                                 |                                      |
+--------------------------------------+--------------------------------------+
| font-family                          | ``monospace`` ``arial`` ``didot``    |
|                                      | ``rockwell`` ``geneva``              |
|                                      | ``helvetica`` ``serif`` ``cursive``  |
|                                      | ``futura`` ``tahoma``                |
|                                      | ``impact`` ``candara`` ``times``     |
|                                      | ``cambria`` ``palatino``             |
|                                      | ``ff-`` ``gadget`` ``baskerville``   |
|                                      | ``courier`` ``font-f-``              |
|                                      | ``monaco`` ``perpetua``              |
|                                      | ``copperplate`` ``verdana``          |
|                                      | ``consolas``                         |
|                                      | ``papyrus`` ``georgia`` ``calibri``  |
|                                      | ``optima`` ``garamond``              |
|                                      | ``charcoal`` ``fantasy``             |
|                                      | ``sans-serif``                       |
+--------------------------------------+--------------------------------------+
...
+--------------------------------------+--------------------------------------+
| font-weight                          | ``bolder`` ``font-w-`` ``lighter``   |
|                                      | ``fw-`` ``fweight-``                 |
|                                      | ``f-weight-`` ``bold``               |
+--------------------------------------+--------------------------------------+
| height                               | ``hei-`` ``h-``                      |

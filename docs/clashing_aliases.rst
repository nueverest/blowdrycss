...
+--------------------------------------+--------------------------------------+
| azimuth                              | ``far-left`` ``far-right``           |
|                                      | ``center-right`` ``center-left``     |
|                                      | ``right-side``                       |
|                                      | ``rightwards`` ``behind``            |
|                                      | ``leftwards`` ``azi-`` ``left-side`` |
+--------------------------------------+--------------------------------------+
| background                           | ``bg-`` ``bac-``                     |
+--------------------------------------+--------------------------------------+
...
| cue-before                           | ``cue-b-`` ``cb-``                   |
+--------------------------------------+--------------------------------------+
| cursor                               | ``wait`` ``text`` ``move``           |
|                                      | ``ne-resize`` ``s-resize``           |
|                                      | ``help`` ``sw-resize`` ``cur-``      |
|                                      | ``crosshair`` ``se-resize``          |
|                                      | ``n-resize`` ``default`` ``pointer`` |
|                                      | ``w-resize`` ``e-resize``            |
|                                      | ``progress`` ``nw-resize``           |
+--------------------------------------+--------------------------------------+
...
| font                                 |                                      |
+--------------------------------------+--------------------------------------+
| font-family                          | ``candara`` ``monaco`` ``courier``   |
|                                      | ``fantasy`` ``arial``                |
|                                      | ``optima`` ``futura`` ``calibri``    |
|                                      | ``verdana`` ``impact``               |
|                                      | ``didot`` ``rockwell`` ``ff-``       |
|                                      | ``geneva`` ``consolas``              |
|                                      | ``cursive`` ``gadget`` ``perpetua``  |
|                                      | ``serif`` ``baskerville``            |
|                                      | ``georgia`` ``monospace``            |
|                                      | ``garamond`` ``helvetica``           |
|                                      | ``palatino``                         |
|                                      | ``font-f-`` ``copperplate``          |
|                                      | ``tahoma`` ``cambria`` ``papyrus``   |
|                                      | ``sans-serif`` ``charcoal``          |
|                                      | ``times``                            |
+--------------------------------------+--------------------------------------+
...
|                                      | ``outside`` ``inside``               |
+--------------------------------------+--------------------------------------+
| list-style-type                      | ``georgian`` ``upper-alpha``         |
...
+--------------------------------------+--------------------------------------+
| speech-rate                          | ``x-fast`` ``speech-r-`` ``sr-``     |
|                                      | ``x-slow`` ``slow``                  |
|                                      | ``slower`` ``faster`` ``fast``       |
+--------------------------------------+--------------------------------------+
| stress                               | ``str-``                             |
...
|                                      | ``unicode-b-``                       |
+--------------------------------------+--------------------------------------+
| vertical-align                       | ``middle`` ``v-align-`` ``text-top`` |
|                                      | ``super`` ``sub``                    |
|                                      | ``valign-`` ``vertical-a-``          |
|                                      | ``text-bottom`` ``baseline`` ``va-`` |
+--------------------------------------+--------------------------------------+

...
| cue-before                           | ``cb-`` ``cue-b-``                   |
+--------------------------------------+--------------------------------------+
| cursor                               | ``s-resize`` ``move`` ``cur-``       |
|                                      | ``se-resize`` ``n-resize``           |
|                                      | ``ne-resize`` ``w-resize`` ``text``  |
|                                      | ``default`` ``e-resize``             |
|                                      | ``wait`` ``progress`` ``sw-resize``  |
|                                      | ``help`` ``crosshair``               |
|                                      | ``nw-resize`` ``pointer``            |
+--------------------------------------+--------------------------------------+
...
| font                                 |                                      |
+--------------------------------------+--------------------------------------+
| font-family                          | ``consolas`` ``font-f-``             |
|                                      | ``garamond`` ``calibri`` ``ff-``     |
|                                      | ``geneva`` ``charcoal`` ``courier``  |
|                                      | ``futura`` ``papyrus``               |
|                                      | ``optima`` ``candara``               |
|                                      | ``copperplate`` ``helvetica``        |
|                                      | ``sans-serif``                       |
|                                      | ``serif`` ``tahoma`` ``arial``       |
|                                      | ``perpetua`` ``gadget``              |
|                                      | ``impact`` ``monaco``                |
|                                      | ``baskerville`` ``fantasy``          |
|                                      | ``rockwell``                         |
|                                      | ``didot`` ``monospace`` ``verdana``  |
|                                      | ``georgia`` ``cursive``              |
|                                      | ``times`` ``palatino`` ``cambria``   |
+--------------------------------------+--------------------------------------+
...
|                                      | ``outside`` ``inside``               |
+--------------------------------------+--------------------------------------+
| list-style-type                      | ``upper-alpha`` ``disc`` ``circle``  |
|                                      | ``armenian`` ``list-s-type-``        |
...
|                                      | ``once``                             |
+--------------------------------------+--------------------------------------+
| speak-numeral                        | ``speak-n-`` ``sn-`` ``digits``      |
|                                      | ``continuous``                       |
+--------------------------------------+--------------------------------------+
| speak-punctuation                    | ``sp-`` ``code`` ``speak-p-``        |
+--------------------------------------+--------------------------------------+
| speech-rate                          | ``speech-r-`` ``fast`` ``faster``    |
|                                      | ``slower`` ``slow``                  |
|                                      | ``sr-`` ``x-fast`` ``x-slow``        |
+--------------------------------------+--------------------------------------+
| stress                               | ``str-``                             |
...
|                                      | ``bidi-override`` ``ub-``            |
+--------------------------------------+--------------------------------------+
| vertical-align                       | ``va-`` ``baseline`` ``valign-``     |
|                                      | ``v-align-`` ``text-bottom``         |
|                                      | ``middle`` ``super`` ``text-top``    |
|                                      | ``vertical-a-`` ``sub``              |
+--------------------------------------+--------------------------------------+

...
| clip                                 |                                      |
+--------------------------------------+--------------------------------------+
| color                                | ``yellow`` ``green`` ``maroon``      |
|                                      | ``hsl`` ``blue``                     |
|                                      | ``black`` ``silver`` ``purple``      |
|                                      | ``fuchsia`` ``aqua``                 |
|                                      | ``rgba`` ``lime`` ``olive`` ``navy`` |
|                                      | ``rgb``                              |
|                                      | ``orange`` ``gray`` ``white``        |
|                                      | ``teal`` ``red``                     |
|                                      | ``c-`` ``hsla``                      |
...
| cue-before                           | ``cb-`` ``cue-b-``                   |
+--------------------------------------+--------------------------------------+
| cursor                               | ``cur-`` ``ne-resize`` ``e-resize``  |
|                                      | ``default`` ``w-resize``             |
|                                      | ``help`` ``move`` ``pointer``        |
|                                      | ``wait`` ``se-resize``               |
|                                      | ``text`` ``n-resize`` ``sw-resize``  |
|                                      | ``nw-resize`` ``crosshair``          |
|                                      | ``progress`` ``s-resize``            |
+--------------------------------------+--------------------------------------+
...
| font                                 |                                      |
+--------------------------------------+--------------------------------------+
| font-family                          | ``didot`` ``font-f-`` ``cambria``    |
|                                      | ``copperplate`` ``monaco``           |
|                                      | ``times`` ``impact`` ``georgia``     |
|                                      | ``optima`` ``helvetica``             |
|                                      | ``perpetua`` ``candara`` ``calibri`` |
|                                      | ``papyrus`` ``gadget``               |
|                                      | ``fantasy`` ``cursive`` ``consolas`` |
|                                      | ``futura`` ``sans-serif``            |
|                                      | ``ff-`` ``garamond`` ``verdana``     |
|                                      | ``geneva`` ``baskerville``           |
|                                      | ``serif`` ``tahoma`` ``rockwell``    |
|                                      | ``palatino`` ``arial``               |
|                                      | ``monospace`` ``courier``            |
|                                      | ``charcoal``                         |
+--------------------------------------+--------------------------------------+
...
+--------------------------------------+--------------------------------------+
| speech-rate                          | ``faster`` ``speech-r-`` ``slow``    |
|                                      | ``slower`` ``x-fast``                |
|                                      | ``sr-`` ``x-slow`` ``fast``          |
+--------------------------------------+--------------------------------------+
| stress                               | ``str-``                             |
